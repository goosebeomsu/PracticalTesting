...
import sample.kiosk.spring.domain.order.OrderStatus;
...
class OrderStatisticsServiceTest {
    ...
    void sendOrderStatisticsMail() {
        // given
        LocalDateTime now = LocalDateTime.of(2024, 2, 9, 1, 1);
        ...
        Order order1 = createPaymentCompletedOrder(LocalDateTime.of(2024, 2, 8, 11, 59, 59), products);
        Order order2 = createPaymentCompletedOrder(now, products);
        Order order3 = createPaymentCompletedOrder(LocalDateTime.of(2024, 2, 10, 0, 0), products);
        ...
        // when
        boolean result = orderStatisticsService.sendOrderStatisticsMail(LocalDate.of(2024, 2, 9), "test@test.com");
